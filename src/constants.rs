...
pub const COLOR: &'static str = "#380874";
pub const HEAD: &'static str = "shac-caffeine";
pub const TAIL: &'static str = "skinny";

// Gravity values
pub const WALL_G: f64 = 2.0;
pub const SMALLER_HEAD: f64 = -7.0;
